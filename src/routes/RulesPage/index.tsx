...
const RulesPage = () => {
    return (
        <Wrapper>
            ...
            <br />
            <br />
            TravelLogger(‘http://quarrelsome-loss.surge.sh’이하 ‘TravelLogger
            웹사이트’) 은(는) 다음의 목적을 위하여 개인정보를 처리하고 있으며,
            ...
            <p className="lh6 bs4">
                ...
                은(는) 정보주체의 동의, 법률의 특별한 규정 등 개인정보 보호법
            ...
            <p className="ls2">
                1. <br />- 위탁받는 자 (수탁자) : <br />- 위탁하는 업무의 내용 :{' '}
                <br />- 위탁기간 : <br />
                <br />②{' '}
                <em className="emphasis">
                    TravelLogger('http://quarrelsome-loss.surge.sh'이하
                ...
                은(는) 위탁계약 체결시 개인정보 보호법 제25조에 따라 위탁업무
            ...
            <p className="ls2">
                ① 정보주체는 TravelLogger(‘http://quarrelsome-loss.surge.sh’이하
                ‘TravelLogger 웹사이트) 에 대해 언제든지 다음 각 호의 개인정보
            ...
            <p className="ls2">
                TravelLogger 은 정보주체의 이용정보를 저장하고 수시로 불러오는
                ‘쿠키’를 사용하지 않습니다.
                <br />
                <br />
                <p className="lh6 bs4">
                ...
                <p className="ls2">
                    ...
                    직급 :개발자
                    <br />
                    연락처 :+821094614321, killi8n@gmail.com, <br />※ 개인정보
                    보호 담당부서로 연결됩니다.
                    <br /> <br />▶ 개인정보 보호 담당부서
                    <br />
                    부서명 :<br />
                    ...
                    연락처 :, , <br />② 정보주체께서는
                    TravelLogger(‘http://quarrelsome-loss.surge.sh’이하
                    ‘TravelLogger 웹사이트) 의 서비스(또는 사업)을 이용하시면서
                    발생한 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에
                    관한 사항을 개인정보 보호책임자 및 담당부서로 문의하실 수
                    있습니다.
                    TravelLogger(‘http://quarrelsome-loss.surge.sh’이하
                    ‘TravelLogger 웹사이트) 은(는) 정보주체의 문의에 대해 지체
                    없이 답변 및 처리해드릴 것입니다.
                </p>
                <br />
                <br />
                ...
                <p className="lh6 bs4">
                    <strong>
                        ...
                        은(는) 개인정보보호법 제29조에 따라 다음과 같이 안전성
                ...
                <p className="ls2">
                    ...
                    <br />
                    3. 문서보안을 위한 잠금장치 사용
                    <br /> 개인정보가 포함된 서류, 보조저장매체 등을 잠금장치가
...
export default withTemplate(RulesPage);
