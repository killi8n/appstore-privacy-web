...
const travelLoggerAppImageUrls = {
    ...
    android: [
        'https://play-lh.googleusercontent.com/0FjfU6ulK-GWM01QKM8iho_ooKYTf02JZej5H3JUNUlEaPNYQx7_qfqPqA625mw16lsF=w720-h310-rw',
        'https://play-lh.googleusercontent.com/PsD4fnfY87ktfoxvKSGmRXd5f1IE-FoyUSX87MWa1bwmID7TK2Ogr9JXhRBrFAs2InM=w720-h310-rw',
        'https://play-lh.googleusercontent.com/jgejb8rrHrbxABOGjdK9lbBJFJyta6T-VBESMXnbDQV5V9d3IKexibcRD39n6JpCBWsc=w720-h310-rw',
        'https://play-lh.googleusercontent.com/ynjNTBKbUHUQji9BbMgSpT4GqgVhiZlncIlwBgtp6b9X7BJPGLss4Xq6S6bDLzGnj3g=w720-h310-rw',
        'https://play-lh.googleusercontent.com/vaws7RTopXCikVOwgItWfdbrNx9Vpeh1KyXREzcRil-j-kMiM7yZJdZdwmjpj_cJ81o=w720-h310-rw',
    ],
};
...
const storeUrl = {
    travelLogger: {
        apple: 'https://apps.apple.com/kr/app/travel-logger/id1491698164',
        android:
            'https://play.google.com/store/apps/details?id=com.travellogger',
    },
    scheduler: {
        apple:
                        ...
                        <AppImageList
                            imageUrls={
                                appName === 'travellogger'
                                    ? travelLoggerAppImageUrls.apple
                                    : schedulerAppImageUrls.apple
                            }
                        />
                    ),
                    android: (
                        <AppImageList
                            imageUrls={
                                appName === 'travellogger'
                                    ? travelLoggerAppImageUrls.android
                                    : schedulerAppImageUrls.android
                            }
                        />
                    ),
                }}
